let data = [
     ...
     */
    {
        label: { name: 'POST' }, key: '0681f25c-4c00-4295-b12a-6ab81a3cb440',  unitKey: '94765b71-4361-412e-80a0-4e5bfe08f2ed', callback: { name: 'post', type: 'consoleLogMessage' },
        insertionPoint: [
     ...
     * WebappUI Port:
     */
    { /*✔*/ label: { name: 'URL: /serviceWorker.js' }, key: '25f4a639-3fcf-4378-9c04-60cf245cd916', unitKey: 'eeace9bc-1ccc-4050-af0b-0aa0f34884e3', callback: { name: '9sadf6-630c-avs985-4b0d52706981', type: 'middlewareNestedUnit' }, },
    { /*✔*/ label: { name: 'URL: /<*>' }, key: 'ab9c2538-cd9e-40d6-9a93-5296db445035', unitKey: 'e971b884-1b33-4044-9c93-162ee145b807', callback: {  name: '12asd-9ab6-43cd-91fd-9eae5843c74c', type: 'middlewareNestedUnit' }, },
     ...
     */
    {
        ...
        children: [
            // '/@<..>'
            { nestedUnit: 'asdf8-8902-437c-a6e1-4a7082f3b281', pathPointerKey: 'XYZ5', insertionPosition: { insertionPathPointer: null, insertionPoint: '2299cc1e-238f-4fe5-9069-51351ded59a7' } },
            // '/asset'
    ...
    { /*✔*/ label: { name: 'URL: /upload' }, key: '182fb317-3361-46dd-9058-5dffd973edb0', unitKey: 'd78cbbb1-4e46-4abe-8839-3edf9c25ccd4', callback: { name: '9w9f-9ab6-43cd-91fd-9eae5843c74c', type: 'middlewareNestedUnit' }, },
    { label: { name: 'URL: <...>$function' }, key: '15a01ebf-8902-437c-a6e1-4a7082f3b281', unitKey: '1b062262-9ef2-4d15-bc87-7bc6b9fef391', callback: {  name: '2yvc-91fd-9eae5843c74c', type: 'middlewareNestedUnit' }, },
    { /*✔*/ 
        label: { name: 'URL: /asset' }, key: 'dceb9ff2-1996-47f4-9e14-83111f4501ce', unitKey: 'af30c7db-4d26-4e4c-bab9-a4a5cc666edb', callback: { name: 'a8sdf52-43cd-91fd-9eae5843c74c', type: 'middlewareNestedUnit' },
        insertionPoint: [
            { key: '2299cc1e-238f-4fe5-9069-51351ded59a7', order: 1, executionType: 'raceFirstPromise' },
        ],
        children: [
    ...
    { /*✔*/ 
        label: { name: 'URL: /@<...>' }, key: 'asdf8-8902-437c-a6e1-4a7082f3b281', unitKey: '9asdf8-9ef2-4d15-bc87-7bc6b9fef391', 
