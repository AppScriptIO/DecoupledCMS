...
const oidcConfiguration = {
  ...
  features: {
    ...
    // dev only - creates interaction views for users. When turned off the custom provided interaction are used.
    encryption: true,
    revocation: true,
    // allows revocation of tokens.
    introspection: true,
    // Allows client to get information about a token meta information (e.g. token validity). https://tools.ietf.org/html/rfc7662
    claimsParameter: true,
    // Allow requesting specific claims for returned "userinfo" object & "id_token" object. https://openid.net/specs/openid-connect-core-1_0.html#ClaimsParameter
    ...
    // false i.e. issue refresh token only when offline_access scope is requested
    // Regarding requests - should be x-www-form-urlencoded by default.
    request: true,
    // allows the request to be sent as one parameter (signed &/or encrypted)  https://openid.net/specs/openid-connect-core-1_0.html#JWTRequests
    requestUri: true,
    // allows passing request details by reference, rather than by value. https://openid.net/specs/openid-connect-core-1_0.html#JWTRequests
    oauthNativeApps: true,
    // Changes redirect_uris validations for clients with application_type native to those defined in OAuth 2.0 for Native Apps - https://tools.ietf.org/html/rfc8252.
